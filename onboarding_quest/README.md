...
> 깃과 터미널 사용은 한 달 전 한 달동안 내내 했었는데, 그 사이에 많은 걸 잊어버려서 놀랍다. 역시 언어든, 어떤 분야든 꾸준히 사용해야 녹슬거나사라지지 않고 내게 남아있을수 있을것같다. 깃에 일기 레포지토리를 만들어서 매일 셸에서 일기를 쓰고(마크다운 연습), 깃허브에 올리는걸 해보아도 좋을 것 같다!(이슬)
